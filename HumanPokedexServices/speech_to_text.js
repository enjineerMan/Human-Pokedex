...
function speechToText(
  ...
  const speechCallback = stream => {
    ...
    //   fs.writeFile('transcribedSpeech.txt', stdoutText, (err) => {
    //     if (err) throw err;
    //    });
      let transcribedSpeechPath = `${FileSystem.documentDirectory}services/transcribedSpeech.txt`;
      ensureDirExists(`${FileSystem.documentDirectory}services/`);
      FileSystem.writeAsStringAsync(transcribedSpeechPath, stdoutText);
...
speechToText(...process.argv.slice(2));